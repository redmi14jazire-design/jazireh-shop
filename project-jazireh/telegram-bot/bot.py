...
PRODUCTS = [
    {"code": "PRD-001", "name": "ساعت مردانه Seiko طلایی — صفحه مشکی بافت‌دار", "price": 2000000, "stock": 15, "category": "ساعت مردانه", "description": "بند استیل طلایی، صفحه مشکی بافت لانه‌زنبوری، شیشه Mineral Crystal، قطر ۴۰mm، موتور کوارتز ژاپنی"},
    {"code": "PRD-002", "name": "ساعت مردانه Seiko طلایی — صفحه آبی سان‌برست", "price": 2000000, "stock": 12, "category": "ساعت مردانه", "description": "بند استیل طلایی، صفحه آبی سان‌برست، عقربه‌های طلایی، تاریخ‌شمار، قطر ۴۰mm"},
    {"code": "PRD-003", "name": "ساعت زنانه Seiko طلایی — صفحه آبی سان‌برست", "price": 2000000, "stock": 18, "category": "ساعت زنانه", "description": "بند استیل طلایی، صفحه آبی سان‌برست، طراحی ظریف، قطر ۳۰mm، مناسب مچ‌های کوچک"},
    {"code": "PRD-004", "name": "ست زوج Seiko طلایی — مردانه و زنانه صفحه آبی", "price": 2000000, "stock": 8, "category": "ست ساعت", "description": "ساعت مردانه ۴۰mm + زنانه ۳۰mm، بند استیل طلایی، جعبه کادویی، هدیه عروسی و سالگرد"},
    {"code": "PRD-005", "name": "ساعت مردانه Seiko نقره‌ای — صفحه سفید مینیمال", "price": 2000000, "stock": 10, "category": "ساعت مردانه", "description": "بند استیل نقره‌ای براق، صفحه سفید خالص، طراحی مینیمال، قطر ۴۰mm"},
    {"code": "PRD-006", "name": "ساعت مردانه Seiko — صفحه مشکی بند چرم اصل", "price": 2000000, "stock": 14, "category": "ساعت مردانه", "description": "بند چرم طبیعی مشکی با دوخت دستی، صفحه مشکی کلاسیک، بدنه استیل، قطر ۴۰mm"},
    {"code": "PRD-007", "name": "ساعت زنانه Seiko — صفحه سفید بند چرم قهوه‌ای", "price": 2000000, "stock": 11, "category": "ساعت زنانه", "description": "بند چرم طبیعی قهوه‌ای، صفحه سفید مینیمال، قطر ۳۰mm، مناسب استایل روزمره و مهمانی"},
    {"code": "PRD-008", "name": "ساعت مردانه Seiko کرونوگراف — صفحه مشکی", "price": 2000000, "stock": 7, "category": "ساعت مردانه", "description": "سه شمارنده فرعی، بند استیل نقره‌ای، قطر ۴۲mm، کرونومتر حرفه‌ای، مناسب استایل اسپرت"},
    {"code": "PRD-009", "name": "ساعت زنانه Seiko — طرح گل طلایی", "price": 2000000, "stock": 9, "category": "ساعت زنانه", "description": "بند استیل طلایی، صفحه طرح گل و نگین، قطر ۲۸mm، طراحی هنری و منحصربه‌فرد"},
    {"code": "PRD-010", "name": "پک ویژه کادویی — ساعت + جعبه چوبی + گارانتی", "price": 2000000, "stock": 20, "category": "پک کادویی", "description": "جعبه چوبی لاکچری، کارت گارانتی ۱۲ ماهه، دستمال میکروفایبر، بسته‌بندی آماده هدیه"},
]
...
ساعت مچی مردانه و زنانه با بهترین قیمت
